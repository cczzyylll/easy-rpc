...
public class RpcConstants {
    ...
    public static final Integer DEFAULT_CORE_THREAD_NUMS=64;
    public static final Integer DEFAULT_MAX_THREAD_NUMS=128;
    public static final Integer DEFAULT_CAPACITY_THREAD_POOL=512;


    public static final Integer DEFAULT_MAX_CONNECTION_NUMS = DEFAULT_MAX_THREAD_NUMS + DEFAULT_CAPACITY_THREAD_POOL;
